...
$hgbEpochs = "115"
$multiclassEpochs = "115"
$mlpEpochs = "40"
$anomalyEstimators = "115"
$fold = "7"
$nFolds = "8"
...
Write-Host "=== UNSW train-all models ===" -ForegroundColor Green
...
RunPy "src\models\UNSW-NB15\train_ml_multiclass_hgb.py" @("--split_mode", "random", "--epochs", $multiclassEpochs)
RunPy "src\models\UNSW-NB15\train_ml_binary_mlp.py" @("--split_mode", "random", "--epochs", $mlpEpochs)
RunPy "src\models\UNSW-NB15\train_anomaly_isoforest.py" @("--split_mode", "random", "--epochs", $anomalyEstimators)

# 4) Groupkfold mode (single fold by default)
RunPy "src\models\UNSW-NB15\train_ml_binary_hgb.py" @("--split_mode", "groupkfold", "--fold", $fold, "--n_folds", $nFolds, "--epochs", $hgbEpochs)
RunPy "src\models\UNSW-NB15\train_ml_multiclass_hgb.py" @("--split_mode", "groupkfold", "--fold", $fold, "--n_folds", $nFolds, "--epochs", $multiclassEpochs)
RunPy "src\models\UNSW-NB15\train_ml_binary_mlp.py" @("--split_mode", "groupkfold", "--fold", $fold, "--n_folds", $nFolds, "--epochs", $mlpEpochs)
RunPy "src\models\UNSW-NB15\train_anomaly_isoforest.py" @("--split_mode", "groupkfold", "--fold", $fold, "--n_folds", $nFolds, "--epochs", $anomalyEstimators)

# 5) Official mode
RunPy "src\models\UNSW-NB15\train_ml_binary_hgb.py" @("--split_mode", "official", "--epochs", $hgbEpochs)
RunPy "src\models\UNSW-NB15\train_ml_multiclass_hgb.py" @("--split_mode", "official", "--epochs", $multiclassEpochs)
RunPy "src\models\UNSW-NB15\train_ml_binary_mlp.py" @("--split_mode", "official", "--epochs", $mlpEpochs)

...
def main() -> None:
    ...
    root = artifacts_root("offline_COWRIE_FULL_binary_hgb", args.split_mode, now_run_id(), dataset=args.dataset, run_config={"sample_frac": args.sample_frac, "epochs": args.epochs})
